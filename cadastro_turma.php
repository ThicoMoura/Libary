...
<?php require_once 'menu_painel.php'; ?>
  ...
  <div class="row">
     ...
     <!--Col s12 = Define o limite de Col-->
      ...
      <form action="insert_turma.php" method="post" enctype="multipart/form-data" class="col s12" id="teste">
        <div class="row">

  <!--Input-field = Define a class input-->

        <div class="input-field col s12">
          <input placeholder="Digite aqui o nome da turma" id="nometur" type="text" class="validate" name="nometur" required>
          <label for="nometur">Titulo</label>
        </div>
